...
/*console.log(((str) => {
    return str.split('.')[1];
})('/admin/userbro/projectX/trpz/script.js'));*/
...
//7
/*console.log((() =>{
     let months = ['січня', 'лютого', 'березня' , 'квітня', 'травня', 'липня', 'червня', 'серпня', 'вересня', 'жовтня', 'листопада', 'грудня'];
